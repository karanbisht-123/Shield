...
//   console.log(previews , 'hii i am xan,sf,sbsbf')
...
//         newErrors.selfieFile = "Selfie file is required.";
//     } else {
//       if (!documents.businessReg)
//         newErrors.businessReg = "Business registration document is required.";
...
//             userType === "individual"
//               ? "bg-gradient-to-br from-[#001F90] to-[#2087C2]"
//               : "bg-gray-400"
//           }`}
//         >
//           Individual
...
//             icon={FaCamera}
//             onFileChange={handleFileChange("selfieFile")}
//             previewUrl={previews.selfieFilePreview}
//             onRemove={handleRemoveFile("selfieFile")}
//           />
//         </div>
//       )}
...
//             <button
//               onClick={startCamera}
//               className="bg-gradient-to-br from-[#001F90] to-[#2087C2] text-white hover:bg-yellow-400 transition-colors duration-300 py-2 px-4 rounded"
//             >
//               Start Camera
//             </button>
//             <button
//               onClick={stopCamera}
//               className="bg-red-600 text-white hover:bg-red-400 transition-colors duration-300 py-2 px-4 rounded"
//             >
//               Stop Camera
//             </button>
//             <button
